...
lt.plugins.auto_complete.string__GT_tokens = (function string__GT_tokens(str,pattern){var s = lt.plugins.auto_complete.stream.call(null,str);var res = (function (){var obj13088 = {};return obj13088;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__13084_SHARP_){return {"completion": p1__13084_SHARP_};
}),Object.keys(res)));
});
...
lt.plugins.auto_complete.non_token_change_QMARK_ = (function non_token_change_QMARK_(ed,ch){var pattern = lt.plugins.auto_complete.get_pattern.call(null,ed);var text = cljs.core.map.call(null,cljs.core.str,ch.text);var pred__13093 = cljs.core._EQ_;var expr__13094 = ch.origin;if(cljs.core.truth_(pred__13093.call(null,"+input",expr__13094)))
{return cljs.core.some.call(null,(function (p1__13089_SHARP_){return cljs.core.not.call(null,cljs.core.re_seq.call(null,pattern,p1__13089_SHARP_));
}),text);
} else
{if(cljs.core.truth_(pred__13093.call(null,"paste",expr__13094)))
{return true;
} else
{return false;
}
...
lt.plugins.auto_complete.w = lt.objs.thread.thread_STAR_.call(null,(function tfun13097(){var orig__4408__auto__ = argsArray(arguments);var msg__4409__auto__ = orig__4408__auto__.shift();var args__4410__auto__ = orig__4408__auto__.map(cljs.reader.read_string);var raise = ((function (orig__4408__auto__,msg__4409__auto__,args__4410__auto__){
...
return (function (str,pattern){var s = stream.call(null,str);var pattern__$1 = cljs.core.re_pattern.call(null,pattern);var res = (function (){var obj13101 = {};return obj13101;
})();skip_space.call(null,s);
while(true){
...
return (function (p1__13096_SHARP_){return {"completion": p1__13096_SHARP_};
...
if(cljs.core.truth_((function (){var or__3408__auto__ = force_QMARK_;if(cljs.core.truth_(or__3408__auto__))
{return or__3408__auto__;
} else
{return cljs.core._EQ_.call(null,0,cljs.core.count.call(null,new cljs.core.Keyword(null,"cur","cur",1014003122).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$))));
}
})()))
{lt.objs.keyboard.passthrough.call(null);
} else
{}
