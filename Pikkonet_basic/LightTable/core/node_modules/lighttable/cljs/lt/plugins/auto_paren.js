...
{return lt.objs.editor.replace_selection.call(null,this$,[cljs.core.str(ch),cljs.core.str(current_selection),cljs.core.str(lt.plugins.auto_paren.pairs.call(null,ch))].join(''));
} else
...
lt.plugins.auto_paren.__BEH__try_remove_pair = (function __BEH__try_remove_pair(this$){var ch = lt.plugins.auto_paren.get_char.call(null,this$,-1);if(cljs.core.truth_((function (){var and__3396__auto__ = lt.plugins.auto_paren.pairs.call(null,ch);if(cljs.core.truth_(and__3396__auto__))
...
{var loc = lt.objs.editor.__GT_cursor.call(null,this$);return lt.objs.editor.replace.call(null,this$,lt.plugins.auto_paren.adjust_loc.call(null,loc,-1),lt.plugins.auto_paren.adjust_loc.call(null,loc,1),"");
} else
{return lt.objs.keyboard.passthrough.call(null);
}
});
