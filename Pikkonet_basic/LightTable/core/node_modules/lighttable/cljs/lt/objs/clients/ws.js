...
lt.objs.clients.ws.on_connect = (function on_connect(socket){socket.on("result",(function (p1__7543_SHARP_){return lt.objs.clients.ws.on_result.call(null,socket,p1__7543_SHARP_);
}));
...
return ws;
}catch (e7544){if((e7544 instanceof Error))
{var e = e7544;return null;
} else
{if((e7544 instanceof global.Error))
{var e = e7544;return null;
} else
...
}catch (e7546){if((e7546 instanceof Error))
{var e = e7546;return null;
} else
{if((e7546 instanceof global.Error))
{var e = e7546;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e7546;
