...
lt.objs.app.default_zoom = 0;
lt.objs.app.window_number = (function window_number(){var n = cljs.core.last.call(null,clojure.string.split.call(null,window.location.search,"="));if(cljs.core.empty_QMARK_.call(null,n))
{return 0;
} else
{return parseInt(n);
}
});
lt.objs.app.win.ltid = lt.objs.app.window_number.call(null);
lt.objs.app.prevent_close = (function prevent_close(){return lt.objs.app.closing = false;
});
lt.objs.app.close = (function close(force_QMARK_){if(cljs.core.truth_(force_QMARK_))
...
{}
return lt.objs.app.win.close(force_QMARK_);
});
lt.objs.app.refresh = (function refresh(){return window.location.reload(true);
});
lt.objs.app.open_window = (function open_window(){var id = lt.objs.app.store_swap_BANG_.call(null,new cljs.core.Keyword(null,"window-id","window-id",796854154),cljs.core.inc);var w = lt.objs.app.gui.Window.open([cljs.core.str("LightTable.html?id="),cljs.core.str(id)].join(''),cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"toolbar","toolbar",4168777453),false,new cljs.core.Keyword(null,"icon","icon",1017130987),"core/img/lticon.png",new cljs.core.Keyword(null,"new-instance","new-instance",4433393044),true,new cljs.core.Keyword(null,"min_height","min_height",4482628390),400,new cljs.core.Keyword(null,"min_width","min_width",1555408139),400,new cljs.core.Keyword(null,"frame","frame",1111596255),true,new cljs.core.Keyword(null,"show","show",1017433711),false], null)));w.ltid = id;
return w;
});
lt.objs.app.args = (function args(){if(cljs.core._EQ_.call(null,0,lt.objs.app.gui.App.argv.length))
{return null;
} else
...
lt.objs.app.extract_BANG_ = (function extract_BANG_(k){var v = lt.objs.app.fetch.call(null,k);lt.objs.app.store_BANG_.call(null,k,null);
return v;
});
...
lt.objs.app.ensure_greater = (function ensure_greater(x,cap){var x__$1 = ((typeof x === 'string')?parseInt(x):x);var x__3715__auto__ = x__$1;var y__3716__auto__ = cap;return ((x__3715__auto__ > y__3716__auto__) ? x__3715__auto__ : y__3716__auto__);
});
lt.objs.app.zoom_level = (function zoom_level(){if(cljs.core.not_EQ_.call(null,lt.objs.app.win.zoomLevel,0))
{return lt.objs.app.win.zoomLevel;
} else
{return null;
}
});
...
{return lt.objs.app.win.enterFullscreen();
} else
{return null;
}
});
...
lt.objs.app.__BEH__restore_position_on_init = (function __BEH__restore_position_on_init(this$){if(cljs.core.empty_QMARK_.call(null,localStorage.width))
{return null;
} else
...
lt.objs.app.__BEH__on_show_bind_navigate = (function __BEH__on_show_bind_navigate(this$){return lt.util.dom.on.call(null,lt.util.dom.$.call(null,new cljs.core.Keyword(null,"#canvas","#canvas",644055725)),new cljs.core.Keyword(null,"click","click",1108654330),(function (e){if(cljs.core._EQ_.call(null,e.target.nodeName,"A"))
{lt.util.dom.prevent.call(null,e);
var temp__4092__auto__ = e.target.href;if(cljs.core.truth_(temp__4092__auto__))
{var href = temp__4092__auto__;lt.objs.app.gui.Shell.openExternal(href);
...
lt.objs.app.__BEH__initial_focus = (function __BEH__initial_focus(this$){return lt.objs.app.win.focus();
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.objs.app","initial-focus","lt.objs.app/initial-focus",3904369177),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.objs.app.__BEH__initial_focus,new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"show","show",1017433711),null], null), null));
/**
* @param {...*} var_args
*/
lt.objs.app.run_commands = (function() { 
var run_commands__delegate = function (this$,commands){if(cljs.core.seq.call(null,commands))
{var commands__$1 = ((cljs.core.vector_QMARK_.call(null,cljs.core.first.call(null,commands)))?cljs.core.first.call(null,commands):commands);var seq__5599 = cljs.core.seq.call(null,commands__$1);var chunk__5600 = null;var count__5601 = 0;var i__5602 = 0;while(true){
if((i__5602 < count__5601))
{var c = cljs.core._nth.call(null,chunk__5600,i__5602);if(cljs.core.coll_QMARK_.call(null,c))
...
{var c = cljs.core.first.call(null,seq__5599__$1);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
...
run_commands.cljs$lang$applyTo = (function (arglist__5615){
var this$ = cljs.core.first(arglist__5615);
var commands = cljs.core.rest(arglist__5615);
...
return lt.objs.app.win.zoomLevel = default$;
});
...
if(cljs.core._EQ_.call(null,0,lt.objs.app.window_number.call(null)))
{lt.objs.app.store_BANG_.call(null,new cljs.core.Keyword(null,"window-id","window-id",796854154),0);
} else
{}
lt.objs.app.win.on("close",(function (){return lt.object.raise.call(null,lt.objs.app.app,new cljs.core.Keyword(null,"close!","close!",3951350939));
}));
lt.objs.app.gui.App.on("open",(function (path){return lt.object.raise.call(null,lt.objs.app.app,new cljs.core.Keyword(null,"open!","open!",1119852169),path);
}));
lt.objs.app.win.on("blur",(function (){return lt.object.raise.call(null,lt.objs.app.app,new cljs.core.Keyword(null,"blur","blur",1016931289));
}));
lt.objs.app.win.on("focus",(function (){return lt.object.raise.call(null,lt.objs.app.app,new cljs.core.Keyword(null,"focus","focus",1111509066));
}));
window.onbeforeunload = (function (){return "This will navigate the main LT window and all work will be lost, are you sure you want to do this?";
});
