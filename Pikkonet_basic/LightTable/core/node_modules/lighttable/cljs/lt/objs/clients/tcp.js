...
}catch (e7536){if((e7536 instanceof Error))
{var e = e7536;return lt.objs.console.error.call(null,e);
} else
{if((e7536 instanceof global.Error))
{var e = e7536;return lt.objs.console.error.call(null,e);
} else
...
return socket.on("data",(function (p1__7539_SHARP_){return lt.objs.clients.tcp.on_result.call(null,socket,p1__7539_SHARP_);
}));
});
...
return s;
}catch (e7540){if((e7540 instanceof Error))
{var e = e7540;return null;
} else
{if((e7540 instanceof global.Error))
{var e = e7540;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e7540;
...
{var e = e7542;return null;
} else
{if((e7542 instanceof global.Error))
{var e = e7542;return null;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e7542;
